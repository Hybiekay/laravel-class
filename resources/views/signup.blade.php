...
<body>
    ...
    <div class=" justify-center flex w-[400px] bg-white px-2  py-5 rounded-lg  ">
        <form class="flex flex-col gap-3 " action="{{ url("/sign-up") }}" method="post">
            @csrf
        <input class=" bg-gray-300 h-12 w-full rounded-xl pl-2 "  
            placeholder="Enter your new name" name="name" type="text">

            <input class=" bg-gray-300 h-12 w-full rounded-xl pl-2 "  
            placeholder="Enter your new name" name="email" type="text">
